...
public class SilverwolfSTATS extends CharacterStats {
    public SilverwolfSTATS() {
        // Add Silverwolf's stats
    ...
    public boolean isEffective(String relicName) {
        // Define which relic stats are effective for Silverwolf
